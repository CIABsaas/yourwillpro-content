---
title: "Disobedience - Brother-in-Law Did Nothing"
slug: "brother-in-law-did-nothing."
category: "Stories"
issue: "Disobedience"
...
order: 3
status: "published"
summary: "A domestic partner waited years for an executor who refused to act, respond, or cooperate."
heroImage: "/images/stories/his-brother-did-nothing.png"
readTime: "5 min read"
...
<div class="stat-block">
  <div class="stat-item">
    ...
    <div class="stat-label">Years of Delay</div>
  </div>
  <div class="stat-item">
    <div class="stat-number">3</div>
    <div class="stat-label">Years Before Probate Application</div>
  </div>
  <div class="stat-item">
    <div class="stat-number">0</div>
    <div class="stat-label">Responses to Letters</div>
  </div>
</div>
...
<div class="timeline">
  <div class="timeline-item">
    ...
    <h4>Michael Dies</h4>
    <p>David is named executor. Anna expects prompt administration.</p>
  </div>
  <div class="timeline-item negative">
    <div class="timeline-year">2019-2020</div>
    <h4>Silence</h4>
    <p>No probate application. Letters go unanswered.</p>
  </div>
  <div class="timeline-item negative">
    <div class="timeline-year">2021</div>
    <h4>Finally Files for Probate</h4>
    <p>Three years after death, David finally lodges application.</p>
  </div>
  <div class="timeline-item negative">
    <div class="timeline-year">2023</div>
    <h4>Court Removes Him</h4>
    <p>After 5 years, court appoints replacement executor.</p>
  </div>
</div>
...
<div class="warning-box">
  ...
  <div>
    <h4>Red Flag: Complete Non-Cooperation</h4>
    <p>Five years of silence. No probate application for three years. No responses to letters. No engagement with mediation. Total executor abandonment.</p>
  </div>
</div>
...
- Showed unreasonable delay in applying for probate
- Failed to respond to requisitions from the Registrar of Probates
- Ignored repeated requests for information from Anna's solicitor
- Neglected to pay the estate's debts
- Refused to cooperate or engage in mediation
...
<div class="success-box">
  ...
  <div>
    <h4>Better Approach: Choose an Executor Who Will Act</h4>
    <p>Family connection isn't enough. Choose someone willing to respond, communicate, and prioritise the estate. Consider naming a professional or backup executor.</p>
  </div>
</div>
