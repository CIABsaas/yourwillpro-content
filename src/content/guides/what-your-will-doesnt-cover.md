---
title: "What Your Will Doesn't Cover"
slug: "what-your-will-doesnt-cover"
category: "Guides"
group: "Deep Dives"
order: 3
status: "published"
summary: "A will is just one piece of the estate planning puzzle. Learn what assets and decisions fall outside your will and how to protect them."
difficulty: "Intermediate"
readTime: "12 min read"
author: "YourWillPro Team"
reviewer: "Estate Planning Expert"
...
<div class="quick-answer">
  <h4>Quick Answer</h4>
  <p>Your will only controls assets you own in your sole name. It <strong>doesn't cover superannuation, jointly owned property, trust assets, or accounts with nominated beneficiaries</strong>. These assets pass according to their own rules — which means they can go to the wrong person if you haven't set them up correctly.</p>
</div>
...
<p class="lead-paragraph">Most Australians assume their will controls everything they own. It doesn't.</p>
...
<div class="australia-note">
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <circle cx="12" cy="12" r="10"/>
    <path d="M12 8v4M12 16h.01"/>
  </svg>
  <div>
    <h4>Australian Law</h4>
    <p>Superannuation is not an asset of your estate. It's held in trust by your super fund and is governed by superannuation law, not estate law.</p>
  </div>
</div>
...
1. **Binding death benefit nominations** (if you have one)
2. **Non-binding nominations** (which the trustee can ignore)
3. **Trustee discretion** (if you have no nomination)
...
<div class="checklist">
  <h4>Requirements for a Valid Binding Nomination</h4>
  <div class="checklist-item">Must be in writing using your fund's official form</div>
  <div class="checklist-item">Must nominate dependants or your legal personal representative (estate)</div>
  <div class="checklist-item">Must be signed by you in the presence of two adult witnesses (who aren't beneficiaries)</div>
  <div class="checklist-item">Witnesses must also sign</div>
  <div class="checklist-item">Must be received by your fund while you're alive</div>
  <div class="checklist-item">Must be renewed every 3 years (unless it's a non-lapsing nomination)</div>
</div>
...
<div class="warning-box">
  ...
  <div>
    <h4>Binding Nominations Expire</h4>
    <p>Most binding death benefit nominations expire after 3 years. If yours has lapsed, your super fund treats it as non-binding — meaning the trustee can ignore it. Check your nomination status every year.</p>
  </div>
</div>
...
<div class="tip-box">
  ...
  <div>
    <h4>Bank Accounts Too</h4>
    <p>Joint bank accounts also operate under joint tenancy. When one owner dies, the account automatically goes to the survivor — even if the will says otherwise.</p>
  </div>
</div>
...
<div class="success-box">
  ...
  <div>
    <h4>Review Trust Deeds</h4>
    <p>If you're involved in a family trust, review the trust deed with your solicitor to understand what happens when you die and whether any changes are needed.</p>
  </div>
</div>
...
1. **Create a digital asset inventory** — list all accounts, platforms, and crypto holdings
2. **Store credentials securely** — use a password manager with emergency access, or leave sealed instructions with your solicitor
3. **Include authority in your will** — specifically authorise your executor to access, manage, and close digital accounts
4. **Back up critical data** — download important files and photos to physical storage
5. **Set up legacy contacts** where available (Facebook, Google)
...
<div class="warning-box">
  ...
  <div>
    <h4>Cryptocurrency Can Be Lost Forever</h4>
    <p>If you hold cryptocurrency in a self-custody wallet and your executor doesn't have your private keys or seed phrase, those funds are <strong>permanently inaccessible</strong>. There is no customer service number to call.</p>
  </div>
</div>
...
1. **Make a separate will** in each country where you own significant assets
2. **Ensure wills don't conflict** — your Australian will should exclude overseas assets, and vice versa
3. **Appoint a local executor** in each jurisdiction or use an international law firm
4. **Consider restructuring** — hold overseas assets through an Australian trust or company instead
...
<div class="tip-box">
  ...
  <div>
    <h4>Seek Specialist Advice</h4>
    <p>If you own property or significant assets overseas, see a solicitor experienced in international estate planning. DIY approaches rarely work across borders.</p>
  </div>
</div>
...
<div class="australia-note">
  ...
  <div>
    <h4>Organ Donation in Australia</h4>
    <p>Registering on the Australian Organ Donor Register provides evidence of your wishes, but your family still has the final say. Discussing your decision with them is the best way to ensure it's honoured.</p>
  </div>
</div>
...
<p class="lead-paragraph">People assume their will covers everything. Here are the most common oversights:</p>

**1. No binding death benefit nomination for super**
Your super is likely your largest asset. Without a binding nomination, you don't control where it goes.

**2. Joint tenancy when you wanted your share to go elsewhere**
If you own property or accounts jointly, check whether joint tenancy is still appropriate for your situation.

**3. Forgetting to update beneficiary nominations after divorce or remarriage**
An old nomination can send your super or life insurance to an ex-partner.

**4. Assuming your executor can access your cryptocurrency**
Without private keys, crypto is lost forever.

**5. Not reviewing partnership or shareholder agreements**
These documents can override your will and prevent your family from inheriting your business.

**6. Relying on your will for funeral wishes**
By the time your will is read, your funeral may already be over.

<div class="key-takeaway">
  <h4><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg> Key Takeaway</h4>
  <p>Your will is essential — but it only controls assets in your sole name. Superannuation, joint property, trust assets, and beneficiary-nominated accounts all operate outside your will. A complete estate plan addresses <strong>all</strong> of these, not just the will.</p>
</div>
...
<div class="step-card">
  ...
  <div class="step-content">
    <h4>Audit Your Super</h4>
    <p>Log into your super fund(s) and check your death benefit nomination. If you don't have a binding nomination, complete one today. Set a reminder to renew it every 3 years.</p>
  </div>
</div>
...
<div class="step-card">
  ...
  <div class="step-content">
    <h4>Check Property Ownership</h4>
    <p>Confirm whether you own property as joint tenants or tenants in common. If it's joint tenancy, decide if that still reflects your wishes.</p>
  </div>
</div>
...
<div class="step-card">
  ...
  <div class="step-content">
    <h4>Review Beneficiary Nominations</h4>
    <p>Check life insurance policies, investment bonds, and any other accounts with beneficiary nominations. Update them if needed.</p>
  </div>
</div>
...
<div class="step-card">
  ...
  <div class="step-content">
    <h4>Create a Digital Asset Plan</h4>
    <p>List your digital accounts and crypto holdings. Store credentials securely and give your executor access instructions.</p>
  </div>
</div>
...
<div class="step-card">
  ...
  <div class="step-content">
    ...
    <p>If you have trust assets, business interests, or overseas property, see a solicitor to ensure all your estate planning documents work together.</p>
  </div>
</div>
...
- [Choosing the Right Type of Will](/guides/choosing-the-right-type-of-will)

**Related Questions**
- [What is a binding death benefit nomination?](/common-questions/what-is-binding-death-benefit-nomination)
- [Can I leave superannuation in my will?](/common-questions/can-i-leave-superannuation-in-my-will)
...
**Planning Tools**
- [Asset Inventory Checklist](/planning-tools/checklists/listing-assets-checklist)
- [Preparation for Will Checklist](/planning-tools/checklists/preparation-for-will-checklist)
